...
def _publish_draft_artifact(client, settings, workspace_manager, run_info, content: str, version: str, round_no: int) -> None:
    artifact_rel = f"{run_info['workspace_root']}/artifacts/article_draft@{version}/payload/article.md"
...
def test_callback_event_id_is_idempotent(client, workflow_fixture, settings, workspace_manager) -> None:
